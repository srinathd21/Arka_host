        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-3 col-md-6 col-6 foot_cours">
                <div>
                    ...
                    <ul>
                        <li><a href="course_details.php?category=Software&title=Data%20Science">Data Science</a></li>
                        <li><a href="course_details.php?category=Software&title=Full%20Stack">Full Stack</a></li>
                        <li><a href="course_details.php?category=Software&title=Ui/Ux">UI/UX Desigin</a></li>
